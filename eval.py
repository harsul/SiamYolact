...
def parse_args(argv=None):
    ...
    parser.add_argument('--trained_model',
                        ...
                        help = 'Trained state_dict file path to open. If "interrupt", this will open the interrupt '
                               'file.')
    ...
    parser.add_argument('--shuffle', dest = 'shuffle', action = 'store_true',
                        help = 'Shuffles the images when displaying them. Doesn\'t have much of an effect when '
                               'display is off though.')
    ...
    parser.add_argument('--display_lincomb', default = False, type = str2bool,
                        help = 'If the config uses lincomb masks, output a visualization of how those masks are '
                               'created.')
    ...
    parser.set_defaults(no_bar = False, display = False, resume = False, output_coco_json = False,
                        ...
                        detect = False, display_fps = False,
